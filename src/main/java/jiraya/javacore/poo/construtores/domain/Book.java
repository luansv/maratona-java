package jiraya.javacore.poo.construtores.domain;
...
public class Book {
    ...
    public Book(String name, int pages, int year, String genre) {
        this.name = name;
        this.pages = pages;
        this.year = year;
        this.genre = genre;
    ...
    public Book(String name, int pages, int year, String genre, String author) {
        this(name, pages, year, genre);
        this.author = author;
    }
